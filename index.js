...
const sqldb = mysql.createConnection('mysql://nbt8f99rri6es8c1i1e6:pscale_pw_W5ximtCYqjFh4Ui2pAW7pAMWmwXXHKM6PeXarPgaPwc@aws.connect.psdb.cloud/uzhavanhouse?ssl={"rejectUnauthorized":true}');
sqldb.connect((err) => {
  if (err) {
    console.error(err);
  } else {
